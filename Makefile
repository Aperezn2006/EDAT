...
runv_e1: p4_e1
	...
	valgrind --leak-check=full --show-leak-kinds=all ./p4_e1 ./data/data_vertex_50K.txt "id:88997 tag:Golf_de_Ibiza" normal
	@echo ""
	valgrind --leak-check=full --show-leak-kinds=all ./p4_e1 ./data/data_vertex_50K.txt "id:88997 tag:Golf_de_Ibiza" sorted
	@echo ""
	valgrind --leak-check=full --show-leak-kinds=all ./p4_e1 ./data/data_vertex_50K.txt "id:889907 tag:Golf_de_Ibiza" normal
	@echo ""
	valgrind --leak-check=full --show-leak-kinds=all ./p4_e1 ./data/data_vertex_50K.txt "id:889907 tag:Golf_de_Ibiza" sorted
