...
float aux_strtof(const char *nptr, char **endptr) {
...
/* String */
void *string_copy(const void *src) { return aux_strdup(src); }
...
void *str2str(const char *str) { return aux_strdup(str); }
